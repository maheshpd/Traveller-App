...
//  Traveller App
//
//  Created by Mahesh Prasad on 18/07/20.
...
struct Detail: View {
    ...
    var body: some View {
        VStack {
            ...
            Image("topbg").resizable().frame(height: 500).aspectRatio(1.35, contentMode: .fill).frame(width: UIScreen.main.bounds.width, height: 500).offset(y: -200).padding(.bottom, -200)
...
struct detailMiddle: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 10) {
            ...
            Text("Number Of People InYour Group").foregroundColor(.gray)
...
struct detailBottom: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 10) {
            ...
            Text("Camping is an outdoor activity involving overnight stays away from home in a shelter, such as a tent or a recreational vehicle.").foregroundColor(.gray)
